...
func GenerateConfig(configs []apiobjects.DNSRecord) {
	...
	file, err := os.OpenFile("/home/nginx.conf", os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0666)
...
`
	...
	tmpl := template.Must(template.ParseFiles("/home/nginx.tmpl"))
...
func ReloadNginx() error {
	...
	cmd = exec.Command("nginx", "-c", "/home/nginx.conf") 
	err = cmd.Run()
	if err != nil {
		log.Error("[ReloadNginx] cmd.Run() failed with ", err.Error())
		return err
