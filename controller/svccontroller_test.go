...
// 	//config.ApiServerIp = "localhost:8080"

// 	podJson1 := "{\n  \"apiVersion\": \"v1\",\n  \"kind\": \"pod\",\n  \"metadata\": {\n    \"name\": \"example-pod1\",\n    \"labels\": {\n      \"app\": \"deploy-1\"\n    }\n  },\n  \"spec\": {\n    \"containers\": [\n      {\n        \"name\": \"example-container\",\n        \"image\": \"nginx\",\n        \"ports\": [\n          {\n            \"containerPort\": 12345,\n            \"name\": \"p1\"\n          }\n        ]\n      }\n    ]\n  },\n  \"Status\":{\n      \"PodIP\":\"10.2.17.54\"\n  }}"
// 	podJson2 := "{\n  \"apiVersion\": \"v1\",\n  \"kind\": \"pod\",\n  \"metadata\": {\n    \"name\": \"example-pod2\",\n    \"labels\": {\n      \"app\": \"deploy-2\"\n    }\n  },\n  \"spec\": {\n    \"containers\": [\n      {\n        \"name\": \"example-container\",\n        \"image\": \"nginx\",\n        \"ports\": [\n          {\n            \"containerPort\": 12345,\n            \"name\": \"p1\"\n          }\n        ]\n      }\n    ]\n  },\n  \"Status\":{\n      \"PodIP\":\"10.2.17.55\"\n  }}"
// 	pod1 := &apiobjects.Pod{}
// 	err := json.Unmarshal([]byte(podJson1), pod1)
// 	if err != nil {
// 		t.Error("Unmarshal Error1")
// 	}
// 	pod2 := &apiobjects.Pod{}
// 	err2 := json.Unmarshal([]byte(podJson2), pod2)
// 	if err2 != nil {
// 		t.Error("Unmarshal Error2")
// 	}

// 	utils.CreateObject(pod1, config.POD, pod1.Data.Namespace)
// 	utils.CreateObject(pod2, config.POD, pod2.Data.Namespace)
...
// 	utils.CreateObject(svc, config.SERVICE, svc.Data.Namespace)
// 	s.HandleCreate([]byte(svcJson))
// 	checkSvc := utils.GetObject(config.SERVICE, "default", "service-practice")
// 	println(checkSvc, "\n")
// 	checkEdpt := utils.GetObject(config.ENDPOINT, "default", "")
// 	println(checkEdpt, "\n")

// 	println("========== Check Service Update ========= ")
// 	svc.UnMarshalJSON([]byte(checkSvc))
// 	svc.Spec.Selector["app"] = "deploy-2"
// 	utils.UpdateObject(svc, config.SERVICE, svc.Data.Namespace, svc.Data.Name)
...
// 	utils.DeleteObject(config.SERVICE, svc.Data.Namespace, svc.Data.Name)
// 	s.HandleDelete(res)
// 	checkEdpt = utils.GetObject(config.ENDPOINT, "default", "")
// 	println(checkEdpt, "\n")
...
// 	}
// 	utils.DeleteObject(config.POD, "default", pod1.Data.Name)
// 	utils.DeleteObject(config.POD, "default", pod2.Data.Name)
...
// 	utils.UpdateObject(pod1, config.POD, pod1.Data.Namespace, pod1.Data.Name)
// 	utils.UpdateObject(pod2, config.POD, pod2.Data.Namespace, pod2.Data.Name)
